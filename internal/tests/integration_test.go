...
import (
	...
	"github.com/khulnasoft/orchard/internal/controller"
	"github.com/khulnasoft/orchard/internal/worker"
	"github.com/khulnasoft/orchard/internal/worker/ondiskname"
	"github.com/khulnasoft/orchard/internal/worker/tart"
...
func TestVMGarbageCollection(t *testing.T) {
	...
	_, _, err = tart.Tart(ctx, logger.Sugar(), "clone",
		"ghcr.io/khulnasoft/macos-ventura-base:latest", vmName)
	require.NoError(t, err)
